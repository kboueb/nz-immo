<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            @php
                $id = Auth::user()->id;
                $sellerData = App\Models\User::find($id);
            @endphp
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img id="showImage" src="{{ (!empty($sellerData->photo)) ? url('upload/seller_images/'.$sellerData->photo) : url('upload/no_image.jpg') }}" class="user-img" alt="Admin">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('seller.profile') }}"><i class="bx bx-user"></i><span>Mon Profil</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('seller.change.password') }}"><i class="bx bx-cog"></i><span>Changer le mot de passe</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('seller.profile') }}"><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('seller.profile') }}"><i class='bx bx-dollar-circle'></i><span>Earnings</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('seller.profile') }}"><i class='bx bx-download'></i><span>Downloads</span></a>
                    </li>
                    <li>
                        <div class="dropdown-divider mb-0"></div>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('seller.logout') }}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
