                                    ...
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">Hello {{$userData->name}}</h3> <br>
                                                <img id="showImage" src="{{ (!empty($userData->photo)) ? url('upload/user_images/'.$userData->photo) : url('upload/no_image.jpg') }}" alt="Admin" style="width:100px;height:100px" class="rounded-circle p-1 bg-primary ">
                                            </div>
                                            <div class="card-body">
                                                <p>
                                                ...
                                                <form action="{{ route('user.dashboard.store') }}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input required="" class="form-control" name="username" type="text" disabled value="{{ $userData->username }}"/>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn btn-fill-out submit font-weight-bold" name="submit" value="Submit">Enregistrer</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
